{
  ...
  "license": {
    "type": "Custom",
    "file": "AmazonMobileAds-ios-2.2.17.0-SDK/LICENSE.txt"
  },
  "authors": {
  ...
  "vendored_frameworks": "AmazonMobileAds-ios-2.2.17.0-SDK/AmazonAd.framework",
  "frameworks": [
    "AdSupport",
    "CoreLocation",
    "SystemConfiguration",
  ...
  "source": {
    "http": "https://amazonadsi-a.akamaihd.net/public/Amazon-Mobile-App-SDK-by-Platform/AmazonMobileAds-ios-2.2.17.0-SDK.zip"
  }
}
